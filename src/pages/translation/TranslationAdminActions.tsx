...
import { GetApp as DownloadIcon, Restore as RestoreIcon, LabelImportant as LabelImportantIcon } from '@mui/icons-material';
  ...
  return (
    <Box sx={{ pt: 1 }}>
      <ButtonGroup variant="contained">
        <Button href="#translation/import" startIcon={<LabelImportantIcon />}>
          Import
        </Button>
        <Button href="#translation/backups" startIcon={<RestoreIcon />}>
          Restore
        </Button>
